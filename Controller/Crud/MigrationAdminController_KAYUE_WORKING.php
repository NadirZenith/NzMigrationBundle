...
class MigrationAdminController extends Controller
{
    ...
    {
        $em = $this->getWpEntityManager();
        $rep = $em->getRepository('NzWordpressBundle:User');
        $wpuser = $rep->find(12);
        ...
        $user = $migrator->handleUser($wpuser);
    ...
    {
        return $this->get(
                sprintf('doctrine.orm.%s_entity_manager', $this->getParameter('kayue_wordpress.entity_manager'))
        );
    }
}
